...
let package = Package(
    ...
    dependencies: [
        ...
        // AdmicroAdsSDK
        .package(url: "https://github.com/CanThaiLinh/AdmicroAdsSDK.git", exact: "2.1.28")
    ],
    targets: [
        // STATIC xcframework từ release 1.1.14 – không có @rpath dependency → SPM compatible
        .binaryTarget(
            name: "IGListKit_AdmicroAdsSDK_Binary",
            url: "https://github.com/CanThaiLinh/IGListKit_AdmicroAdsSDK/releases/download/1.1.15/IGListKit_AdmicroAdsSDK_V2.zip",
